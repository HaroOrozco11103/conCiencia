...
@include("layouts.popup")
	<div class="contenido">
        ...
        <!--División entre datos y respuestas-->
    	<div class="row">
        	<div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 grupo" id="Cabeza">
                        ...
                        <div class="options">
        	                ...
        	                <input class="box" type="checkbox" name="hocico_proboscide" value="hocico_proboscide" id="hocico_proboscide"> <label for="hocico_proboscide"> Hocico probóscide </label>
                        ...
                        <div class="options">
                            <div class="row">
                            	...
                            	<div class="col-md-6">
                                	...
                                	<input class="box" type="checkbox" name="incisivos_superiores_dos" value="incisivos_superiores_dos" id="incisivos_superiores_dos"> <label for="incisivos_superiores_dos"> Dos incisivos superiores, inferiores. </label>
             	       ...
             	       <div class="options">
                            <div class="row">
                            	<div class="col-md-5">
                                	...
                                	<input class="box" type="checkbox" name="pentadactilo" value="pentadactilo" id="pentadactilo"> <label for="pentadactilo"> Pentadáctilo (5 dedos) </label>
